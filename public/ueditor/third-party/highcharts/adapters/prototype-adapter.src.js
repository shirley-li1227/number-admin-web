...
var HighchartsAdapter = (function () {
	...
	let hasEffect = typeof Effect !== 'undefined';
	 ...
	 */
		getScript: function (scriptLocation, callback) {
			let head = $$('head')[0]; // Returns an array, so pick the first element.
			if (head) {
	 ...
	 */
		addNS: function (eventName) {
			let HTMLEvents = /^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/,
