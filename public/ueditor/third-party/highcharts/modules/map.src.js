...
(function (Highcharts) {
	...
	let MapAreaPoint = Highcharts.extendClass(Point, {
		/**
		 * Extend the Point object to split paths
		 */
		applyOptions: function (options, x) {

			let point = Point.prototype.applyOptions.call(this, options, x);
	...
	seriesTypes.map = Highcharts.extendClass(seriesTypes.scatter, {
		...
		drawLegendSymbolGradient: function (legend, item) {
			let spacing = legend.options.symbolPadding,
		...
		drawPoints: function () {
			...
			each(series.data, function (point) {
				...
				let dataLabels = point.dataLabels,
