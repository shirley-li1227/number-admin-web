...
(function (Highcharts, UNDEFINED) {
	let arrayMin = Highcharts.arrayMin,
		...
		init: function (options, chart, firstAxis) {
			...
			if (backgroundOption) {
				each([].concat(splat(backgroundOption)).reverse(), function (config) {
					let backgroundColor = config.backgroundColor; // if defined, replace the old one (specific for gradients)
 ...
 */
	let GaugePoint = Highcharts.extendClass(Highcharts.Point, {
	/**
	 ...
	 */
		translate: function () {
			...
			each(series.points, function (point) {
				...
				let dialOptions = merge(options.dial, point.dial),
 ...
 *****************************************************************************/
	 ...
	 */
		applyOpacity: function (fill) {
			let markerOptions = this.options.marker,
	 ...
	 */
		convertAttribs: function () {
			let obj = Series.prototype.convertAttribs.apply(this, arguments);
	 ...
	 */
		drawLegendSymbol: function (legend, item) {
			let radius = pInt(legend.itemStyle.fontSize) / 2;
 ...
 */
	...
	let seriesProto = Series.prototype,
 ...
 */
	wrap(colProto, 'alignDataLabel', function (proceed, point, dataLabel, options, alignTo, isNew) {
		...
		if (this.chart.polar) {
			let angle = point.rectPlotX / Math.PI * 180,
				align,
				verticalAlign;
